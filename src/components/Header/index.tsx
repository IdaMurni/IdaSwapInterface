...
const UNIAmount = styled(AccountElement)`
  ...
  background: radial-gradient(174.47% 188.91% at 1.84% 0%, rgb(21, 153, 87) 0%, #2172e5 100%), #edeef2;
`
  ...
  return (
    <HeaderFrame>
      ...
      <HeaderRow>
        <Title href=".">
          <UniIcon>
            <img width={'40px'} src={isDark ? LogoDark : Logo} alt="logo" />
          </UniIcon>
        </Title>
        <HeaderLinks>
            ...
            <UNIWrapper onClick={toggleClaimModal}>
              <UNIAmount active={!!account && !availableClaim} style={{ pointerEvents: 'auto' }}>
                <TYPE.white padding="0 2px">
                  {claimTxn && !claimTxn?.receipt ? <Dots>Claiming UNI</Dots> : 'Claim IDA'}
                </TYPE.white>
              </UNIAmount>
              <CardNoise />
            </UNIWrapper>
