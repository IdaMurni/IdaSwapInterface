...
export const ROUTER_ADDRESS = '0x33AfA1A1a9343b2dfdf9B8a0615bEfC0A4584B14'
export const FACTORY_ADDRESS = '0x8F8c3A7ccD2980b9A7b5cfadc5d1Cf638dc1427A'
...
export const UNI: { [chainId in ChainId]: Token } = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, UNI_ADDRESS, 18, 'IDA', 'IdaMurni'),
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], IDA, WMTC]
}
...
export const CUSTOM_BASES: { [chainId in ChainId]?: { [tokenAddress: string]: Token[] } } = {
  [ChainId.MAINNET]: {
    [WMTC.address]: [IDA, WETH[ChainId.MAINNET]]
  }
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], IDA]
}
